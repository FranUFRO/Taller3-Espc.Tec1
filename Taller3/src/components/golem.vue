<template>
    ...
    <div class="container">
      <div>
        ...
        <div class="sprite golem-animation"></div>
      </div>
    </div>  
...
.sprite {
  ...
  background-image: url('../imagenesinicio/gIdle.png'); /* Ruta a la imagen del sprite */
  background-repeat: no-repeat;
  background-size: cover;
  background-color: red;
}

@keyframes golem-animation {
  0% { background-position: 0 0; }
  16.66% { background-position: -64px 0; }
  33.33% { background-position: -128px 0; }
  50% { background-position: -192px 0; }
  66.66% { background-position: -256px 0; }
  83.33% { background-position: -320px 0; }
  100% { background-position: 0 0; }
}

.golem-animation {
  animation: golem-animation 3s steps(6) infinite;
}
</style>
3