<template>
    ...
    <div class="container">
      <div>
        ...
        <div class="sprite wizard-animation"></div>
      </div>
    </div>  
...
.sprite {
  ...
  background-image: url('../imagenesinicio/wIdle.png'); /* Ruta a la imagen del sprite */
...
.wizard-animation {
  animation: wizard-animation 3s steps(6) infinite;
}
</style>
3