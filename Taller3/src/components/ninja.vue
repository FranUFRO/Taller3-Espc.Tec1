<template>
    ...
    <div class="container">
      <div>
        ...
        <div class="sprite ninja-animation"></div>
      </div>
    </div>  
...
.sprite {
  ...
  background-image: url('../imagenesinicio/kIdle.png'); /* Ruta a la imagen del sprite */
...
.ninja-animation {
  animation: ninja-animation 3s steps(6) infinite;
}
</style>
